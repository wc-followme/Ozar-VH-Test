...
export function UserInfoForm() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        <Label htmlFor="role-category" className="text-[14px] font-semibold text-[var(--text-dark)]">
          Role Category
        </Label>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
        <div className="space-y-2">
          <Label htmlFor="full-name" className="text-[14px] font-semibold text-[var(--text-dark)]">
            Full Name
          </Label>
          <Input
            id="full-name"
        ...
        <div className="space-y-2">
          <Label htmlFor="designation" className="text-[14px] font-semibold text-[var(--text-dark)]">
            Designation
          </Label>
          <Input
            id="designation"
        ...
        <div className="space-y-2">
          <Label htmlFor="date-joining" className="text-[14px] font-semibold text-[var(--text-dark)]">
            Date Of Joining
          </Label>
         <Popover>
  ...
  <PopoverContent className="bg-[var(--white-background)] border border-[var(--border-dark)] shadow-[0px_2px_8px_0px_#0000001A] rounded-[8px]">
    ...
    />
         ...
         <div className="space-y-2">
          <Label htmlFor="email" className="text-[14px] font-semibold text-[var(--text-dark)]">
            Email
          </Label>
          <Input
            id="email"
        ...
        <div className="space-y-2">
          <Label htmlFor="phone" className="text-[14px] font-semibold text-[var(--text-dark)]">
            Phone Number
          </Label>
  ...
  <Input
    ...
    className={cn(
      "h-12 flex-1 rounded-r-[10px] rounded-l-none border-2 border-l-0 border-[var(--border-dark)]",
      "focus:border-green-500 focus:ring-green-500",
      "bg-[var(--white-background)]"
    )}
  />
        ...
        <div className="space-y-2">
          <Label htmlFor="communication" className="text-[14px] font-semibold text-[var(--text-dark)]">
      ...
      {/* Third Row - Address */}
      <div className="space-y-2">
        <Label htmlFor="address" className="text-[14px] font-semibold text-[var(--text-dark)]">
          Address
        </Label>
        <Input
          id="address"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="space-y-2">
          <Label htmlFor="city" className="text-[14px] font-semibold text-[var(--text-dark)]">
            City
          </Label>
          <Input
            id="city"
        ...
        <div className="space-y-2">
          <Label htmlFor="pin-code" className="text-[14px] font-semibold text-[var(--text-dark)]">
            Pin Code
          </Label>
          <Input
            id="pin-code"
