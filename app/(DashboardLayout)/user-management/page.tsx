...
const dummyUsers = [
  ...
  },
  {
    ...
    image: "https://images.pexels.com/photos/2625122/pexels-photo-2625122.jpeg?auto=compress&cs=tinysrgb&w=150&h=150&dpr=2",
    status: true,
  },
  {
    id: 7,
  ...
  },
  {
    ...
    image: "https://images.pexels.com/photos/1542085/pexels-photo-1542085.jpeg?auto=compress&cs=tinysrgb&w=150&h=150&dpr=2",
    status: true,
  },
];
  ...
  return (
    <div className="w-full p-6 overflow-y-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <h1 className="text-2xl font-medium text-[var(--text-dark)]">Admin / User Management</h1>
          ...
          <div className="flex items-center gap-4">
            <Select value={filter} onValueChange={setFilter}>
              ...
              <SelectContent className="bg-white border border-[#E8EAED] shadow-[0px_2px_8px_0px_#0000001A] rounded-[8px]">
