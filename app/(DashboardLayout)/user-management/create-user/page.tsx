    ...
    <div className="">
      <div className="">
        ...
        <div className="flex items-center text-sm text-gray-500 mb-6 mt-2">
          <span className="text-[var(--text-dark)] text-[14px] font-normal">User Management</span>
          <ChevronRight className="h-4 w-4 mx-2" />
          <span className="text-[var(--text-dark)] text-[14px] font-normal text-[var(--primary)]">Add User</span>
        </div>
          ...
          <Tabs value={selectedTab} onValueChange={setSelectedTab} className="w-full">
            ...
            <TabsContent value="info" className="pt-8">
              ...
              <div className="flex justify-end gap-2 mt-8">
                <Button variant="outline" className="h-[48px] px-8 border-2 border-[var(--border-dark)] bg-transparent rounded-full font-semibold text-[var(--text-dark)]">
                  Cancel
                </Button>
            ...
            <TabsContent value="permissions" className="p-8">
              <div className="text-center py-16">
                ...
                <p className="text-gray-500">Configure user permissions and access levels here.</p>
              </div>
            </TabsContent>
          </Tabs>
        </div>
